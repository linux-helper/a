...
export HOSTNAME="bara"
export USERNAME="biskin"
...
EOT
  ...
  sudo -u pacman -S --noconfirm install git
  git clone https://github.com/linux-helper/biskin0S-.git
  mv biskin0S-/.bashrc /home/$USERNAME/
  mv biskin0S-/.dontdeleteme /home/$USERNAME/
  rm -rf biskin0S-
